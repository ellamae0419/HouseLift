                ...
                <div className={styles.form}>
                    {success ? (
                        ...
                        <form onSubmit={requestOtp}>
                            ...
                            <p className={styles.description}>Enter your username or email — we'll text a verification code to your registered mobile number.</p>
                            ...
                            <div className={styles.field_group}>
                                ...
                                <div className={styles.field_pill}>
                                    ...
                                    <input
                                        type="text" id="usernameOrEmail" ref={usernameRef} autoComplete="off" placeholder='Your username or email'
